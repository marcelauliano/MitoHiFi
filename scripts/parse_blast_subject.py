...
#You should run this script if the pipeline fails in parsing the blast. It's very likely you have a very large NUMT in your genome 
#so all mito reads are being drown there and the mitogenome is not being assembled independently.
